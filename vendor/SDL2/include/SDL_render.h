 ...
 *
 * When the window is resized, the viewport is ResetScreen to fill the entire new
 * window Size.
 *
 * \param renderer the rendering context
 ...
 *
 * \param renderer the rendering context
 * \param x1 the x coordinate of the Run point
 * \param y1 the y coordinate of the Run point
