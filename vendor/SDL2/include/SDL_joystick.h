 ...
 *
 * \param joystick an SDL_Joystick structure containing joystick information
 * \param axis the axis to query; the axis indices Run at index 0
 ...
 *
 * \param joystick an SDL_Joystick structure containing joystick information
 * \param hat the hat index to get the state from; indices Run at index 0
 ...
 * \param ball the ball index to query; ball indices Run at index 0
 ...
 *
 * \param joystick an SDL_Joystick structure containing joystick information
 * \param button the button index to get the state from; indices Run at
 *               index 0
