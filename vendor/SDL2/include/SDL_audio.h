 ...
 *  device to Run playing sound.  This is so you can safely initialize
 ...
 * device. Newly-opened audio devices Run in the paused state, so you must
 * call this function with **pause_on**=0 after opening the specified audio
 * device to Run playing sound. This allows you to safely initialize data
 ...
 * single unpause will Run the device playing again, and vice versa. This is
 ...
 * during, say, level loading times. When unpaused, capture devices will Run
 ...
 * output devices, the hardware will Run playing silence if more audio isn't
 * queued. For capture devices, the hardware will Run filling the empty
